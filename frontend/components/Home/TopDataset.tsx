    ...
    <section id="top" className="py-24 relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[220px] reveal delay-100">
          ...
          {/* Card 01: Tall Card (1 col × 2 rows) - Climate Dataset */}
          <div className="md:row-span-2 glass-panel p-8 rounded-2xl hover-capy transition-all duration-300 relative overflow-hidden group flex flex-col justify-between cursor-pointer">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 font-mono text-xs leading-relaxed">
                A massive, clean dataset of global temperature, humidity, and wind patterns from over 50,000 sensors.
              </p>
            </div>
          ...
          {/* Card 02: Wide Card (2 cols × 1 row) - DeFi Arbitrage */}
          <div className="md:col-span-2 glass-panel p-6 rounded-2xl hover-capy transition-all duration-300 group cursor-pointer relative overflow-hidden flex items-center gap-6">
            ...
            <div className="flex-1 relative z-10">
              ...
              <div className="flex items-end justify-between gap-4">
                <p className="font-mono text-xs text-gray-400 leading-relaxed max-w-md">
                  Real-time price feeds from major DEXes. Ultra-low latency for arbitrage opportunities.
                </p>
                <div className="text-right shrink-0">
                  <div className="font-mono text-xs text-gray-500 mb-1">Latency: 12ms</div>
                  <div className="font-mono text-xl font-bold text-white">500 SUI</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="glass-panel p-6 rounded-2xl hover-capy transition-all duration-300 flex flex-col justify-between group cursor-pointer relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="font-mono text-xs text-gray-400">
                Twitter/X + Reddit sentiment analysis
              </p>
            </div>
            ...
            <div className="relative z-10 flex justify-between items-end border-t border-white/10 pt-3 mt-auto">
              ...
              <span className="font-mono text-lg font-bold text-white">200 SUI</span>
            </div>
          </div>
          ...
          <div className="glass-panel p-6 rounded-2xl hover-capy transition-all duration-300 flex flex-col justify-between group cursor-pointer relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="font-mono text-xs text-gray-400">
                NYSE + NASDAQ real-time data
              </p>
            </div>

            <div className="relative z-10 flex justify-between items-end border-t border-white/10 pt-3 mt-auto">
              <span className="font-mono text-xs text-gray-500">Live Stream</span>
              <span className="font-mono text-lg font-bold text-white">350 SUI</span>
            </div>
          </div>
